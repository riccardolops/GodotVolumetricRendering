...
namespace VolumetricRendering
{
    ...
    public partial class VolumeRenderedObject : MeshInstance3D
    {
        ...
        [Export]
        private Gradient transferFunctionColor;
        [Export]
        private Gradient transferFunctionAlpha;
        [Export]
        ...
        private void UpdateMatInternal()
        {
            ...
            {
                transferFunctionColor = transferFunction.GetTextureColor().Gradient;
                transferFunctionAlpha = transferFunction.GetTextureAlpha().Gradient;
